...
| project_id | INTEGER | NOT NULL, FOREIGN KEY -> projects(id) | 所属项目ID |
...
| project_id | INTEGER | NOT NULL, FOREIGN KEY -> projects(id) | 所属项目ID |
| document_id | INTEGER | FOREIGN KEY -> documents(id) | 来源文档ID |
...
| project_id | INTEGER | NOT NULL, FOREIGN KEY -> projects(id) | 所属项目ID |
| execution_id | TEXT | NOT NULL | 关联的执行ID |
...
test_executions (1) ---- (1) test_reports
```
...
CREATE INDEX IF NOT EXISTS idx_reports_created_at ON test_reports(created_at);
